...
const TRIPS = [
  {
    ...
    color: "#ff4d9d",
    price: "$900 – $1,300",
    priceNote: "per person · 4 nights · group of ~10 · all-in",
    nights: "4 nights",
    breakdown: [
      { label: "✈️ Round-trip flights", cost: "$200 – $350" },
      { label: "🏨 South Beach stay (4 nts, split)", cost: "$250 – $400" },
      { label: "🍔 Food", cost: "$150 – $250" },
      { label: "🍻 Bars, clubs & covers", cost: "$200 – $350" },
      { label: "🚕 Rides & activities", cost: "$100 – $150" }
    ],
  ...
  },
  {
    ...
    breakdown: [
      { label: "✈️ Flights to port (Miami/Orlando, RT)", cost: "$250 – $350" },
      ...
      { label: "🏨 Pre-cruise hotel night (optional)", cost: "$60 – $100" }
    ],
  ...
  },
  {
    ...
    nights: "4 nights",
    breakdown: [
      { label: "✈️ Flights (to Miami or Key West)", cost: "$250 – $450" },
      { label: "🏨 Old Town stay (4 nts, split)", cost: "$350 – $500" },
  ...
  },
  {
    ...
    nights: "5 nights",
    breakdown: [
      { label: "🚗 Gas / drive (split per car)", cost: "$40 – $80" },
  ...
  },
  {
    ...
    breakdown: [
      { label: "✈️ Round-trip flights", cost: "$200 – $350" },
      { label: "🏨 Downtown Airbnb (3 nts, split)", cost: "$150 – $250" },
  ...
  },
  {
    ...
    breakdown: [
      { label: "🚗 Gas / drive (split per car)", cost: "$40 – $80" },
      { label: "🏨 Oceanfront condo (4 nts, split)", cost: "$150 – $250" },
